...
I am comfortable working with Python, TypeScript, React, and REST API development. I want to work on backend API endpoints, validation logic, or frontend component fixes. I want to avoid large database migrations or complex infrastructure setup for my first issue.
